...
export const metadata: Metadata = {
  ...
  description: "AI voice simulation for cognitive assessment and dementia diagnosis conversations. Medicare reimburses CPT 99483 at ~$260, yet over 50% of cognitive impairment cases in primary care go undiagnosed. Train the conversation providers avoid.",
  openGraph: {
    title: "Cognitive Assessment Simulation — ClinicalSim.ai",
    description: "Train providers to conduct cognitive assessments and deliver dementia diagnoses. CPT 99483 reimburses ~$260 per visit.",
