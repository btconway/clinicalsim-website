...
<p className="text-lg text-gray-800 font-light leading-relaxed">Standardized patient encounters cost $150-300 each and can't scale to meet ACGME communication competency requirements. AI voice simulation provides unlimited practice reps at a fraction of the cost — complementing, not replacing, live simulation for high-stakes assessments.</p>
</div>
