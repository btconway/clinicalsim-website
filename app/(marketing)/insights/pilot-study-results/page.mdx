...
<p className="text-lg text-gray-800 font-light leading-relaxed">A randomized controlled trial with PICU fellows found that AI voice simulation practice improved communication competence scores on blinded evaluation, reduced learner anxiety, and was rated highly useful — making ClinicalSim.ai among the first AI communication platforms with published RCT evidence.</p>
</div>
...
Deliberate language practice — rehearsing the exact words you'd use to deliver devastating news — turns out to be something clinicians rarely get to do. The AI simulation provides a space for this kind of detailed, repetitive practice.
...
ClinicalSim.ai is among the first AI communication training platforms with published RCT data. This places us in the top tier of evidence quality for the medical education technology market.
