...
<p className="text-lg text-gray-800 font-light leading-relaxed">A randomized controlled trial with PICU fellows found that AI voice simulation practice improved communication competence scores on blinded evaluation, reduced learner anxiety, and was rated highly useful — making ClinicalSim.ai the only AI communication platform with published RCT evidence.</p>
</div>
