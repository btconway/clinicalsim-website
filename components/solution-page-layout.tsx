            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {relatedPosts.map((post) => (
                <Link
                  ...
                  className="group block bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:border-warm/30 transition-all duration-300 border-glow-hover"
                >
